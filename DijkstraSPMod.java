...
public class DijkstraSPMod {
    ...
    public DijkstraSPMod(Domain G, int s) {
...
public DijkstraSPMod(Domain G, int s, int t) {
        distTo = new double[G.V()];
        edgeTo = new DirectedEdge[G.V()];
        for (int v = 0; v < G.V(); v++)
            distTo[v] = Double.POSITIVE_INFINITY;
        ...
        // init pq all vertices without source node
...
// relax edge e and update pq if changed
    ...
    public static void main(String[] args) {
        ...
        DijkstraSPMod sp = new DijkstraSPMod(G, s, 5);
